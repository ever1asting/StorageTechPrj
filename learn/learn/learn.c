...
char bufPath[200] = "/home/ywn/StoragePrj/learn/learn/fuse_temp/";
char pythonPath[200] = "/home/ywn/StoragePrj/learn/learn/";
...
int getCourseList(struct User * user)
{
	Py_Initialize();
			...
			printf("%s\n",pythonPathAdd);
			PyRun_SimpleString(pythonPathAdd);*/
			PyRun_SimpleString("sys.path.append('/home/ywn/StoragePrj/learn/learn/')");
